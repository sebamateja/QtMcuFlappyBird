...
Item {
    ...
    function resetGame() {
        player.x = Theme.playerXStartPosition
        player.y = Theme.playerYStartPosition
        obstacles.x = Theme.appWidth + obstacles.width
        root.points = 0.0
    ...
    Image {
        ...
        width: 30; height: 30;
        x: Theme.playerXStartPosition; y: Theme.playerYStartPosition;
    }
        ...
        onTriggered: {
            ...
            if(doOverlap(player.x, player.y, player.x + player.width, player.y + player.height,
                ...
                resetGame()
                        ...
                        obstacles.x, Theme.appHeight-obstacles.secondRandomHeight, obstacles.x + obstacles.width, obstacles.y + Theme.appHeight)) {
                resetGame()
